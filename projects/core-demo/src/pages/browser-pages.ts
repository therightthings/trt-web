...
const supportChecks: Record<string, () => boolean> = {
  ...
  'media-core': () => BrowserMedia.isSupported(),
...
const pages: Record<string, DemoPageConfig> = {
  ...
  'media-core': {
    title: 'BrowserMedia',
    path: 'browser/media',
    description: 'Access media devices, screen streams and MediaRecorder.',
    methods: ['isSupported()', 'getUserMedia()', 'getDisplayMedia()', 'startRecording()'],
  },
  camera: {
    title: 'BrowserCamera',
